...
namespace UnitTests
{
    ...
    {
        private static readonly IContainer MainFolder = new Folder("First")
        ...
        public static IEnumerable<object[]> GetSizeData()
        {
            yield return new object[] { MainFolder, 25 };
        ...
        {
            var copiedFolder = ((ICopiable)_thirdFolder).Copy(MainFolder);
        ...
        {
            var copiedFile = _firstFile.Copy(MainFolder);
